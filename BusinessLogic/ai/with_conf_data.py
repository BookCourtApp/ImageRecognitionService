...
def ocr(image, ocr_paddle):
    ...
    for bbox in boxes[0]:
        ...
        if h > w:
            ...
            if (not ocr_counter.empty) and (not ocr_clockwise.empty):
                ...
                if max_clockwise < max_counter:
                    tmp_word_cond.append(ocr_counter.set_index('text')['conf'].to_dict())
                    word_lst = ocr_counter['text'].tolist()
                else:
                    tmp_word_cond.append(ocr_clockwise.set_index('text')['conf'].to_dict())
        ...
        # horizontal spine
            ...
            tmp_word_cond.append(ocr_st.set_index('text')['conf'].to_dict())
